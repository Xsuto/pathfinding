...
import { type Accessor, createEffect, createSignal, type JSX, startTransition } from "solid-js";
...
export function Maze(props: GenericMazeProps) {
  ...
  return (
    <div class="lg:p-4 p-2 flex flex-col h-full gap-2 border rounded flex-1">
      ...
      <footer class={cn("grid transition-all duration-300 ease-in-out relative")}>
